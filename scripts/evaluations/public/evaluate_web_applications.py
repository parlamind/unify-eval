...
"""
We evaluate DistilBert on the WebApplications corpus (one of the Sebischair corpora).
...
setup = DefaultSetup(user_name="mohamed", data="WebApplicationsCorpus", model_name="webapps_distilbert",
